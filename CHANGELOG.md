...
* Clone methods, FieldType size functions by @aldas in https://github.com/aldas/go-modbus-client/pull/39
* Registers writevalue by @aldas in https://github.com/aldas/go-modbus-client/pull/40
